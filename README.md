...
Monitoring Raydium v4 for the addition of new liquidity to buy that token.
Implementing Take Profit and Stop Loss functionalities, where Take Profit triggers an automatic sell when the price reaches a certain percentage, and Stop Loss triggers a sell if the price drops by a certain percentage.
...
- Convert some SOL to USDC or etc.
  - You need USDC depending on the configuration set below.
